...
import '../components/css/Referrals.css';
      ...
      <div className="main-content">
        <div className="left-content">
          <div className="button-container">
            <a href="#" className="referrals-button">Referrals</a>
          </div>
          ...
          <div className="instructions">
            ...
            <ol>
              ...
              <li>Invite Friends to Sign Up: They Receive a 10% Bonus on their First Completed Task</li>
              <li>You will Earn a 10% Bonus for Every Task your Friends Complete</li>
            </ol>
          </div>
          ...
          <div className="summary">
            ...
            <div className="summary-details">
              ...
              <div className="bonus-earned">
                <h5>Bonus Earned</h5>
                <div className="detail">
                  <img src="/assets/bitcoin.png" alt="bitcoin" className="icon" />
                  <span>- 0</span>
                </div>
              </div>
            </div>
        ...
        <div className="right-content">
          <img src="/assets/handshake.png" alt="handshake" className="large-image" />
          <div className="image-group">
            <img src="/assets/money.png" alt="money" className="medium-image" />
            <img src="/assets/notebook.png" alt="notebook" className="medium-image" />
          </div>
        </div>
      </div>
    </div>
